        ...
        <div className="w-full lg:w-80 flex-shrink-0">
          <div className="bg-gray-50 rounded-lg p-5 mb-6 border">
            ...
            <button className="w-full mt-4 bg-blue-600 text-white py-2 rounded font-semibold flex items-center justify-center gap-2 hover:bg-blue-700 transition">
              <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M15 8a3 3 0 11-6 0 3 3 0 016 0z" stroke="#fff" strokeWidth="2"/><path d="M2 21v-2a4 4 0 014-4h12a4 4 0 014 4v2" stroke="#fff" strokeWidth="2"/></svg>
              Share Event
            </button>
          </div>
